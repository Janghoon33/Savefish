...
<html lang="en">
  <head>
    ...
    <title>구해줘 피쉬 | 일반 회원 회원가입페이지</title>
    <link
      rel="shortcut icon"
      ...
      <div class="join_form">
        <table>
          ...
          <tbody>
            ...
            <tr>
              <th><span>아이디</span></th>
              <td><input type="text" name="mem_id" placeholder="ID 를 입력하세요."></td>
            </tr>
            <tr>
              <th><span>닉네임</span></th>
            ...
            <tr>
              ...
              <td><input type="text" name="" placeholder="비밀번호를 확인하세요"></td>
            </tr>
