		...
		<br> <br>
			...
			<div class="css-1d3w5wq ex9n9fh0">
				...
				<form action="WriteTitleCon2" method="post">
					<input type="text" name="Title" contenteditable="true" placeholder="제목을 입력해주세요" style="height:70px; width:700px; padding-left: 5px;
   						 font-family: 'Jua', sans-serif; font-size:40px"  > 				
					<li>
				...
				<!-- </form> -->
					<section class="css-1x2chn8 e1v0089b0">
						<main data-testid="gig-detail-left" class="css-lri68t eagiu670">
							...
							<section data-testid="GigTextHTML" class="css-1fui805 e18qb8jq2"
								...
								<input name="Caretext1" data-testid="title" style="font-size: 20px; font-weight: 700; color: rgb(48, 52, 65);" class="css-m786e7 e18qb8jq1" placeholder="전문가 소개 텍스트1 ">
									
								<!-- <div data-testid="description" class="css-qopeqa e18qb8jq0"> -->
							...
							<section data-testid="GigTextHTML" class="css-1fui805 e18qb8jq2"
								contenteditable="true">
								<input name="Caretext2" data-testid="title" style="font-size: 20px; font-weight: 700; color: rgb(48, 52, 65);" class="css-m786e7 e18qb8jq1" placeholder="전문가 소개 텍스트2">
								
							</section>
							<section data-testid="GigTextHTML" class="css-1fui805 e18qb8jq2"
								contenteditable="true">
								<input name="Caretext3" data-testid="title"   style="font-size: 20px; font-weight: 700; color: rgb(48, 52, 65);" class="css-m786e7 e18qb8jq1" placeholder="전문가 소개 텍스트3">
								
							</section>

							<section data-testid="GigGallery" class="css-115ssso e1qlwcpi2"
								contenteditable="true">
								<div data-testid="gallery-item" class="css-0 e1qlwcpi1">
								
									<img
										src="https://d2v80xjmx68n4w.cloudfront.net/gigs/3iEu71648188431.jpg"
										alt="상세이미지-0" loading="lazy" class="css-tvh8ir e1qlwcpi0">
								</div>
					...
					<!-- <form action="WriteTitleCon2" method="post">	 -->		
								<input type="text" name="SubTitle" contenteditable="true" placeholder="소제목 입력칸" style="height:30px; width:300px; padding-left: 5px;
