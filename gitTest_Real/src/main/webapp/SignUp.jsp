      ...
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          ...
          >
              ...
              <button type="button" onclick="location.href='Join.jsp'" style="border-radius: 10px; background-color: gray; padding: 50px 30px 50px 30px;">일반회원</button>
              <button type="button" onclick="location.href='ExJoin.jsp'" style="border-radius: 10px; background-color: gray; padding: 50px 30px 50px 30px;">전문가들</button>
