      ...
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          ...
          >
              ...
              <br>
              <br>
              <button type="button" onclick="location.href='signup일반회원.jsp'" style="border-radius: 10px; background-color: gray; padding: 50px 30px 50px 30px;"><strong>일반회원</strong></button>
              <button type="button" onclick="location.href='signup전문가.jsp'" style="border-radius: 10px; background-color: gray; padding: 50px 30px 50px 30px;"><strong>전문가들</strong></button>
