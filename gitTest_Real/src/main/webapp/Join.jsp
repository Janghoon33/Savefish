      ...
      <div class="join_form">
        <table>
          ...
          <form action="JoinCon" method="post">
            ...
            <tr>
              <th><span>아이디</span></th>
              <td><input type="text" name="mem_id" id="mem_id" placeholder="ID 를 입력하세요."></td>
            </tr>
            <tr>
              <th><span>닉네임</span></th>
              <td><input type="text" name="mem_nick" placeholder="닉네임을 입력하세요."></td>
            </tr>
            <tr>
              <th><span>비밀번호</span></th>
              <td><input type="text" name="mem_pw" placeholder="비밀번호를 입력해주세요."></td>
            </tr>
            <tr>
              <th><span>이메일 입력</span></th>
              <td><input type="text" name="mem_email" placeholder="이메일을 입력하세요"></td>
            </tr>       
            <tr>
              <th><span>확인</span></th>
...
<!--       <div class="btn_wrap">
        <a href="#"><p onclick="alert('회원가입이 되었습니다')">확인</p></a> 
        </form> -->
