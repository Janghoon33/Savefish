      ...
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            ...
            data-wow-delay=".15s" style="margin-left: 380px; margin-right: 380px;"
          >
              <div class="mb-10 text-center">
                ...
                >
                  <img src="./assets/images/니모미.png" alt="logo" />
                </a>
              </div>
              

              <button type="button" onclick="location.href='login.jsp'" style="border-radius: 10px; background-color: gray; padding: 50px 30px 50px 30px;">일반회원</button>
              <button type="button" onclick="location.href='ExLogin.jsp'" style="border-radius: 10px; background-color: gray; padding: 50px 30px 50px 30px;">전문가들</button>
