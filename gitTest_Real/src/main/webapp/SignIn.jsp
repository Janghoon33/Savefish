      ...
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            ...
            data-wow-delay=".15s" style="margin-left: 380px; margin-right: 380px; height: 550px;"
          >
              <div class="mb-10 text-center" >
                <a
                  href="javascript:void(0)"
                  class="mx-auto inline-block max-w-[160px]" style="zoom: 2;"
                >
                  <img src="로고1-2.svg" alt="logo" />
                </a>
              </div>
              <br>
              <br>

              <button type="button" onclick="location.href='signin일반.html'" style="border-radius: 10px; background-color: gray; padding: 50px 30px 50px 30px;"><strong>일반회원</strong></button>
              <button type="button" onclick="location.href='signin전문가.html'" style="border-radius: 10px; background-color: gray; padding: 50px 30px 50px 30px;"><strong>전문가들</strong></button>
