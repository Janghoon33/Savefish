      ...
      <div class="join_form">
        <table>
          ...
          <form action="ExJoinCon" method="post">
            ...
            <tr>
              <th><span>이름</span></th>
              <td><input type="text" name="ex_name" placeholder=""></td>
            </tr> 
            <tr>
              <th><span>아이디</span></th>
              <td><input type="text" name="ex_id" id="ex_id" placeholder="ID 를 입력하세요."></td>
            </tr>
            <tr>
              <th><span>비밀번호</span></th>
              <td><input type="text" name="ex_pw" placeholder="비밀번호를 입력해주세요."></td>
            </tr>

            <tr>
              <th><span>휴대폰 번호</span></th>
              <td><input type="text" name="ex_phone"placeholder="휴대폰 번호를 입력하세요."></td>
            </tr>
            
            <tr>
              <th><span>소속</span></th>
              <td><input type="text" name="ex_team" placeholder="ID 를 입력하세요."></td>
            </tr>           
             <tr>
