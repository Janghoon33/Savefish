...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./전문가상세페이지/전문가상세.css" /><!--혹시몰라서-->
    <style>
      *{
  ...
  <div
    class="relative z-10 overflow-hidden bg-primary pt-[120px] pb-[100px] md:pt-[130px] lg:pt-[160px]" style="padding-top: 13px;"
  >
    <div class="container">
...
<form method="post" enctype="multipart/form-data" action="ExFileCon">
  <div>
    ...
    <!-- directory 업로드로 할 경우 파일을 업로드할 수 없음!! -->
